...
timing_data = []
with open(r'D:\Documents\LEARNING\Professional_Testing\Tutorial videos\python\Ex_Files_Scripting_for_Testers\Exercise Files\02_01\begin\TestTimingData.csv') as csv_file:
...
with open(r'D:\Documents\LEARNING\Professional_Testing\Tutorial videos\python\Ex_Files_Scripting_for_Testers\Exercise Files\column_chart.html','w') as f:
